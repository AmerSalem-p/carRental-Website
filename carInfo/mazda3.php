...
<label>Mazda3 Axela</label>

<figure>
  <img class="image" src="../images/mazda.jpg" alt="mazda">
  <img class="image" src="../images/mazda2.jpg" alt="mazda">
  <img class="image" src="../images/mazda3.jpg" alt="mazda">
</figure>
    ...
    <div id="car-info">
      ...
      <table>
        ...
        <tr class="info">
          <td class="brand">Mazda3</td>
          <td class="model">Axela</td>
          <td class="year">2009</td>
          <td class="price">40</td>
          <td class="country">Japan</td>
          <td class="capacity">5</td>
          <td class="color">Red</td>
          <td class="fuel">0.08</td>
          <td class="horsepower">148</td>
          <td class="length">4.3</td>
